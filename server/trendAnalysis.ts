...
export function formatTrendReportForAI(report: TrendReport): string {
  ...
  return [
    ...
    "- These are YOUR context as a mentor, not a report to be read aloud to the client.",
    "- Never quote numbers directly (e.g. do NOT write 'your average urge is 2/10'). Translate data into human observations.",
    "  Good: 'I notice your urges have stayed pretty manageable lately'",
    "  Bad:  'While your overall urge level has been stable and relatively low, average 2 out of 10'",
    "- For negative patterns (sleep missed, declining mood, high urges), lead with the person's experience — not the number.",
    "  Good: 'I can see things have been heavier this week — your mood has dipped and sleep looks off'",
    "  Bad:  'Your mood is decreasing: first-half average 6.2/10, second-half average 4.1/10'",
    "- If data is insufficient, express natural curiosity rather than a clinical disclaimer.",
    "  Good: 'I'd love to get a clearer picture of your patterns as you keep checking in'",
    "  Bad:  'Insufficient data — need at least 5 entries to identify trends'",
    "- Do NOT contradict any stated trend. If mood is labeled stable, it is stable.",
    "=== END STATISTICS ===",
  ].join("\n");
}

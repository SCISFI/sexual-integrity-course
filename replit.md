...
-   **Trend-Aware AI Feedback**: All AI feedback generators (week, check-in, autopsy) now incorporate trend analysis including mood/urge trajectories (comparing older vs newer halves), check-in consistency rates, and relapse history context for more personalized, data-driven feedback.
